                ...
                <div className="sm:mx-auto sm:w-full sm:max-w-md">
                  ...
                  <div className="mt-6">
                    ...
                    <div className="mt-6 grid grid-cols-3 gap-3">
                      <button
                        type="button"
                        className="flex w-full items-center justify-center rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                      >
