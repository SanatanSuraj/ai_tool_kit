  ...
  const unitTools = [
    {
      ...
      description: 'Convert between meters, feet, inches, kilometers, miles and other length units with precision.',
      icon: 'RulerIcon',
      color: 'blue',
    ...
    },
    {
      ...
      description: 'Convert between kilograms, pounds, ounces, tons and more weight and mass units.',
      icon: 'ScaleIcon',
      color: 'green',
    ...
    },
    {
      ...
      description: 'Convert between liters, gallons, cubic meters, and other volume measurement units.',
      icon: 'BeakerIcon',
      color: 'amber',
    ...
    },
    {
      ...
      description: 'Convert between mph, km/h, m/s, knots and other speed or velocity units.',
      icon: 'BoltIcon',
      color: 'red',
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <section className="py-16 md:py-24 relative overflow-hidden">
        <div className="absolute inset-0 -z-10">
          ...
          <div className="absolute bottom-0 right-1/4 w-64 h-64 rounded-full bg-cyan-100/30 blur-3xl"></div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 fade-in-bottom">Unit Converter</h1>
            
            <p className="text-xl text-gray-600 mb-8 fade-in-bottom [animation-delay:200ms]">
              Convert between different units of measurement with high precision. Our unit conversion tools make calculations easy.
            </p>
      ...
      <section className="py-8 pb-24">
        <div className="container mx-auto px-4">
          ...
          {isLoading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {(searchTerm !== '' ? filteredTools : unitTools).map((tool, index) => (
                <Link 
                  key={tool.id} 
                  href={tool.url} 
