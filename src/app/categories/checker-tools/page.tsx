        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <div className="flex justify-center fade-in-bottom [animation-delay:300ms]">
              <Link href="/" className="group text-fuchsia-600 font-medium flex items-center hover:text-fuchsia-700 transition-colors">
        ...
        <section className="py-4 mb-8">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
              {checkerTools.filter(tool => tool.popular).map((tool, index) => (
