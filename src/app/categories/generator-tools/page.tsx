...
export default function GeneratorToolsPage() {
  ...
  // Mock data for generator tools
  const generatorTools = [
    {
      id: 'password-generator',
      name: 'Password Generator',
      description: 'Create strong, secure passwords with customizable options for length and complexity.',
      icon: 'KeyIcon',
      color: 'purple',
    ...
    },
    {
      ...
      description: 'Generate QR codes for websites, text, contact information, and more with customizable designs.',
      icon: 'QrCodeIcon',
      color: 'indigo',
    ...
    },
    {
      ...
      description: 'Create SEO-friendly meta tags for your website content to improve search engine visibility.',
      icon: 'TagIcon',
      color: 'sky',
    ...
    },
    {
      ...
      description: 'Generate placeholder text for design mockups and layouts with adjustable parameters.',
    ...
    },
    {
      id: 'uuid-generator',
      name: 'UUID Generator',
      description: 'Create unique identifiers for applications and databases with various UUID versions.',
    ...
    },
    {
      ...
      description: 'Design beautiful gradients and get the CSS code instantly with live previews.',
      icon: 'SwatchIcon',
      color: 'rose',
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <section className="py-16 md:py-24 relative overflow-hidden">
        <div className="absolute inset-0 -z-10">
          ...
          <div className="absolute top-0 left-1/4 w-64 h-64 rounded-full bg-purple-100/30 blur-3xl"></div>
          ...
          <div className="absolute bottom-20 left-1/4 w-2 h-2 rounded-full bg-violet-400 opacity-40 animate-pulse [animation-delay:2s]"></div>
        </div>
        
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto">
            <div className="flex justify-center mb-4 scale-in-center">
              <div className="bg-purple-100 p-3 rounded-xl shadow-sm shadow-purple-200">
                <SparklesIcon className="h-8 w-8 text-purple-600" />
              </div>
            </div>
            
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 fade-in-bottom">Generator Tools</h1>
            
            <p className="text-xl text-gray-600 mb-8 fade-in-bottom [animation-delay:200ms]">
              Create various types of content and resources with just a few clicks. From passwords to QR codes, we've got you covered.
            </p>
            
            <div className="flex justify-center fade-in-bottom [animation-delay:300ms]">
              <Link href="/#all-tools-categories" className="group text-purple-600 font-medium flex items-center hover:text-purple-700 transition-colors">
        ...
        <section className="py-4 mb-8">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
              {generatorTools.filter(tool => tool.popular).map((tool) => (
                <Link key={tool.id} href={tool.url} className="group">
                  <div className="bg-white rounded-xl shadow-sm hover:shadow-md p-6 border border-gray-100 h-full transition-all duration-200 group-hover:-translate-y-1 transform-gpu">
                    ...
                    <h3 className="text-xl font-semibold text-gray-900 mb-2 group-hover:text-purple-600 transition-colors">{tool.name}</h3>
                    <p className="text-gray-600">{tool.description}</p>
                    
                    <div className="mt-4 text-purple-600 font-medium flex items-center opacity-80 group-hover:opacity-100 transition-opacity">
                      Try Now
      ...
      <section className="py-8 pb-24">
        <div className="container mx-auto px-4">
          ...
          {isLoading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {(searchTerm !== '' ? filteredTools : generatorTools).map((tool, index) => (
                <Link 
                  key={tool.id} 
                  href={tool.url} 
