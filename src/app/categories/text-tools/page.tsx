...
export default function TextToolsPage() {
  ...
  // Mock data for text tools
  const textTools = [
    {
      id: 'text-to-speech',
      name: 'Text to Speech',
      description: 'Convert written text into natural-sounding speech with multiple voices and languages.',
    ...
    },
    {
      ...
      description: 'Create and edit Markdown with real-time preview and export options.',
    ...
    },
    {
      ...
      description: 'Compare two text samples and highlight the differences between them.',
      icon: 'DocumentDuplicateIcon',
      color: 'amber',
      url: '/tools/text-difference',
      popular: false,
    },
    {
      ...
      <section className="py-16 md:py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 fade-in-bottom">Text Tools</h1>
            
            <p className="text-xl text-gray-600 mb-8 fade-in-bottom [animation-delay:200ms]">
              Transform and manipulate text content with our powerful text processing tools. Create, edit, and analyze text with ease.
            </p>
        ...
        <section className="py-4 mb-8">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
              {textTools.filter(tool => tool.popular).map((tool) => (
      ...
      <section className="py-8 pb-24">
        <div className="container mx-auto px-4">
          ...
          {isLoading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {(searchTerm !== '' ? filteredTools : textTools).map((tool, index) => (
                <Link 
                  key={tool.id} 
                  href={tool.url} 
