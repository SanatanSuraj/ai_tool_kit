...
export default function CalculatorPage() {
  ...
  const calculatorTools = [
    ...
    },
    {
      ...
      description: 'Calculate the time difference between two times or add/subtract hours, minutes, and seconds.',
      icon: 'ClockIcon',
      color: 'purple',
    ...
    },
    {
      ...
      description: 'Convert between human-readable dates and Unix epoch timestamps with millisecond precision.',
    ...
    },
    {
      id: 'age-calculator',
      name: 'Age Calculator',
      description: 'Calculate exact age in years, months, weeks, days, hours, and minutes from any date.',
      icon: 'UserIcon',
      color: 'amber',
    ...
    },
    {
      ...
      description: 'Calculate business days between dates, excluding weekends and holidays for work planning.',
      icon: 'BriefcaseIcon',
      color: 'rose',
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <section className="py-16 md:py-24 relative overflow-hidden">
        <div className="absolute inset-0 -z-10">
          ...
          <div className="absolute top-0 left-1/4 w-64 h-64 rounded-full bg-indigo-100/30 blur-3xl"></div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto">
            <div className="flex justify-center mb-4 scale-in-center">
              <div className="bg-indigo-100 p-3 rounded-xl shadow-sm shadow-indigo-200">
            ...
            <div className="flex justify-center fade-in-bottom [animation-delay:300ms]">
              <Link href="/#all-tools-categories" className="group text-indigo-600 font-medium flex items-center hover:text-indigo-700 transition-colors">
        ...
        <div className="container mx-auto px-4">
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 max-w-md mx-auto">
            <div className="relative">
              ...
              <input
                type="text"
                className="block w-full pl-10 pr-3 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-sm text-gray-900"
              ...
              {calculatorTools.filter(tool => tool.popular).map((tool, index) => (
                <Link key={tool.id} href={tool.url} className="group">
                  <div className="bg-white rounded-xl shadow-sm hover:shadow-md p-6 border border-gray-100 h-full transition-all duration-200 group-hover:-translate-y-1 transform-gpu">
                    ...
                    <h3 className="text-xl font-semibold text-gray-900 mb-2 group-hover:text-indigo-600 transition-colors">{tool.name}</h3>
                    <p className="text-gray-600">{tool.description}</p>
                    
                    <div className="mt-4 text-indigo-600 font-medium flex items-center opacity-80 group-hover:opacity-100 transition-opacity">
                      Try Now
