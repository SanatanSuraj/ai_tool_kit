        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-8">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-3xl md:text-4xl font-bold text-gray-900">YAML Converter</h1>
                <p className="text-gray-600 text-sm md:text-base mt-1">Convert between YAML and JSON formats with syntax highlighting and validation</p>
              </div>
            </div>
