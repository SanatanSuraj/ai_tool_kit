                ...
                <div className="mb-6">
                  <div className="relative">
                    <textarea
                      ...
                      className="w-full h-72 p-4 border-2 rounded-xl font-mono text-base border-gray-300 focus:outline-none focus:ring-2 focus:ring-rose-500 focus:border-transparent shadow-inner bg-white"
